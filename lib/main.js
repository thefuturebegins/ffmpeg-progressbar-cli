...
/**
 * File path for which version of ffmpeg to use.
 * @constant
 */
const BAR_FFMPEG_FILE_PATH = process.env.BAR_FFMPEG_FILE_PATH
 ...
 * @constant
 */
const ffmpegFilepath = BAR_FFMPEG_FILE_PATH || which.sync('ffmpeg')
